...
class ModelPaymentTodopago extends Model {
    ...
    public function upgrade(){
        /*******************************************************************
        *Al no tener breaks entrará en todod los case posteriores.         *
        ...
        *******************************************************************/
        ...
        switch ($actualVersion){
            ...
            case "0.9.9":
                $this->upgrade1_0_0();
            case "1.0.0":
                $this->db->query("INSERT INTO `".DB_PREFIX."setting` (`store_id`, `group`, `key`, `value`, `serialized`) VALUES (0, 'todopago', 'version', '1.0.0', 0)");
        }
    }
    
    public function upgrade1_0_0(){
